...
public class RequestParamController {
    ...
    public String requestParamRequired(@RequestParam(value = "username", required=true) String username,
                                       @RequestParam(value = "age", required=false) Integer age){   // int는 null 불가능
    ...
    public String requestParamDefault(@RequestParam(value = "username", required=false, defaultValue="guest") String username,
